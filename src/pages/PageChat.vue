    ...
    <q-footer elevated>
        <q-toolbar>
            <q-form @submit="sendMessage" class="full-width">
                <q-input ref="newMessage" bg-color="white" rounded outlined  v-model="newMessage" label="Mensagem" dense>
                    <template v-slot:after>
                    <q-btn @click="sendMessage" color="white" round dense flat type="submit" icon="send" />
                    </template>
                </q-input>
            </q-form>
        </q-toolbar>
